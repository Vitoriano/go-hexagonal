...
import (
	...
	application "github.com/Vitoriano/go-hexagonal/application"
...
// MockProductPerssistenceInterface is a mock of ProductPerssistenceInterface interface.
type MockProductPerssistenceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPerssistenceInterfaceMockRecorder
}

// MockProductPerssistenceInterfaceMockRecorder is the mock recorder for MockProductPerssistenceInterface.
type MockProductPerssistenceInterfaceMockRecorder struct {
	mock *MockProductPerssistenceInterface
}

// NewMockProductPerssistenceInterface creates a new mock instance.
func NewMockProductPerssistenceInterface(ctrl *gomock.Controller) *MockProductPerssistenceInterface {
	mock := &MockProductPerssistenceInterface{ctrl: ctrl}
	mock.recorder = &MockProductPerssistenceInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPerssistenceInterface) EXPECT() *MockProductPerssistenceInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPerssistenceInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPerssistenceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPerssistenceInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPerssistenceInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPerssistenceInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPerssistenceInterface)(nil).Save), product)
}
