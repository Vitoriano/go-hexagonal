...
type ProductService struct {
	Persistence ProductPerssistenceInterface
}

func NewProductService(perssistence ProductPerssistenceInterface) *ProductService {
	return &ProductService{Persistence: perssistence}
}
